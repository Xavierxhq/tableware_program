...
class ResNet(nn.Module):
    ...
    def load_param(self, model_path=None):
        if model_path is None:
            model_path = '/home/ubuntu/Program/Dish_recognition/program/model/pretrained/resnet50-19c8e357.pth'
        param_dict = th.load(model_path)
        for i in param_dict:
            if 'fc' in i or i not in self.state_dict():
                print('skip model parameter:', i)
                continue
